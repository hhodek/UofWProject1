...
1.	Are there trends in job satisfaction geographically? (the one I am answering)
    ...
    ![alt text](https://github.com/hhodek/UofWProject1/tree/gar_branch/canada_project/results/province_bar_percent.png?raw=true "Satisfaction percentages by province")
